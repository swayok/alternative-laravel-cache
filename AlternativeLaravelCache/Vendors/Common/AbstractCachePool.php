...
namespace AlternativeLaravelCache\Vendors\Common;

use AlternativeLaravelCache\Vendors\Common\Exception\CacheException;
...
abstract class AbstractCachePool implements PhpCachePool, LoggerAwareInterface, CacheInterface
{
     ...
     * @param PhpCacheItem $item
     */
    protected function saveTags(CacheItemInterface $item)
    {
        $tags = $item->getTags();
        foreach ($tags as $tag) {
